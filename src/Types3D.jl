...
Base.@kwdef struct TweezerParams3D
    ...
    single_trap_amplitude::Float64 = 1.0   # ua at start/end when move_in_single_trap=true
    z_aux_offset::Float64 = 0.0   # axial focus offset of auxiliary tweezer [dimless = μm]
end
